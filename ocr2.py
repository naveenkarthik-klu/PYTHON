...
from app.ocr import initialize_knn_knowledge, detect_character
s_by_knn, count_by_characters
...
binary_image = imclearborder
(binary_image.copy(), 50)

k_nearest = initialize_knn_knowledge
(os.path.join(os.getcwd(),
              "data/ocr /matched_characters.txt"),
 os.path.join(os.getcwd(),
              "data/ocr/matched_images.txt"))

detected_character_str = detect_characters_by_knn(
    binary_image, cv_image, k_nearest)
